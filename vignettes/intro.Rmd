...
You can correct a sentence using, **currently experimental** `correct_text()` function. It requires udpipe installation and will load a model of your choosing into the working directory.
```{r}
correct_text("Total Profit across all Regions are 85 M", download_udpipe = FALSE)
```
