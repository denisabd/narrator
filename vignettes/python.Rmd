...
#reticulate::virtualenv_create("narrator")
#python <- "~/.virtualenvs/narrator/bin/python"

#if (file.exists(python)) use_python(python, required = TRUE)
#reticulate::virtualenv_install(envname = "narrator", packages = "pynarrator")
